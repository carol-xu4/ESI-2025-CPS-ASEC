...
# Selecting Variables ------------------------------------------------------
ppdata = pppub %>% select(
    PERIDNUM, PH_SEQ, P_SEQ, A_LINENO,              # IDs / structure
    ...
    MIL, VACARE, CHAMPVA, PCHIP, IHSFLG,            # other public
    HEA,                                            # health
    MOOP,                                           # spending
